"""SLA stress harness for conduct_interview (hiring_pipeline).

Generated by flowforge — do not edit. Regen with ``flowforge jtbd-generate``.

Workflow breach budget: 432000s (120h).
...
_BUDGET_MS = 432000000
_P95_MS = 2000


class ConductInterviewSlaUser(HttpUser):
	"""Fires ``POST /conduct-interview/events`` at the SLA-implied rate."""
