"""SLA stress harness for complete_hire (hiring_pipeline).
...
class CompleteHireSlaUser(HttpUser):
	"""Fires ``POST /complete-hire/events`` at the SLA-implied rate."""
