"""SLA stress harness for screen_candidate (hiring_pipeline).

Generated by flowforge — do not edit. Regen with ``flowforge jtbd-generate``.

Workflow breach budget: 259200s (72h).
...
_BUDGET_MS = 259200000
_P95_MS = 2000


class ScreenCandidateSlaUser(HttpUser):
	"""Fires ``POST /screen-candidate/events`` at the SLA-implied rate."""
