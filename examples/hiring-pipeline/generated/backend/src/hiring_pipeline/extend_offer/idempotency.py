...
The helper writes the per-JTBD ``extend_offer_idempotency_keys``
...
IDEMPOTENCY_TABLE: str = "extend_offer_idempotency_keys"
...
async def check_idempotency_key(
	*,
	...
	raise NotImplementedError(
		...
		"See backend/src/hiring_pipeline/extend_offer/idempotency.py "
