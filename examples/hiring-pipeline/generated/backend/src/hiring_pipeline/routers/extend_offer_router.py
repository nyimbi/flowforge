"""FastAPI router for Extend an offer.

Exposes ``POST /extend-offer/events`` so a frontend step
...
from ..extend_offer.idempotency import (
	IDEMPOTENCY_TTL_HOURS,
	check_idempotency_key,
	fingerprint_request,
	record_idempotency_response,
)
from ..services.extend_offer_service import ExtendOfferService
...
router = APIRouter(prefix="/extend-offer", tags=["extend_offer"])
_service = ExtendOfferService()
...
async def post_event(
	...
	span_attrs: dict[str, Any] = {
		...
		"flowforge.jtbd_id": "extend_offer",
