"""FastAPI router for Conduct interview loop.

Exposes ``POST /conduct-interview/events`` so a frontend step
...
from ..conduct_interview.idempotency import (
	IDEMPOTENCY_TTL_HOURS,
	check_idempotency_key,
	fingerprint_request,
	record_idempotency_response,
)
from ..services.conduct_interview_service import ConductInterviewService
...
router = APIRouter(prefix="/conduct-interview", tags=["conduct_interview"])
_service = ConductInterviewService()
...
async def post_event(
	...
	span_attrs: dict[str, Any] = {
		...
		"flowforge.jtbd_id": "conduct_interview",
