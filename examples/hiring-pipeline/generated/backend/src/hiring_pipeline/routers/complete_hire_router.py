"""FastAPI router for Complete hire and onboard.

Exposes ``POST /complete-hire/events`` so a frontend step
...
from ..complete_hire.idempotency import (
	IDEMPOTENCY_TTL_HOURS,
	check_idempotency_key,
	fingerprint_request,
	record_idempotency_response,
)
from ..services.complete_hire_service import CompleteHireService
...
router = APIRouter(prefix="/complete-hire", tags=["complete_hire"])
_service = CompleteHireService()
...
async def post_event(
	...
	span_attrs: dict[str, Any] = {
		...
		"flowforge.jtbd_id": "complete_hire",
