...
The helper writes the per-JTBD ``screen_candidate_idempotency_keys``
...
IDEMPOTENCY_TABLE: str = "screen_candidate_idempotency_keys"
...
async def check_idempotency_key(
	*,
	...
	raise NotImplementedError(
		...
		"See backend/src/hiring_pipeline/screen_candidate/idempotency.py "
