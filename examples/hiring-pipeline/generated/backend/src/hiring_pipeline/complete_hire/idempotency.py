"""Idempotency dedupe helper for Complete hire and onboard (v0.3.0 W2 / item 6).

Generated by flowforge JTBD generator — do not edit by hand.

Used by the FastAPI router and domain service to enforce
``Idempotency-Key`` on ``POST /complete-hire/events``:
...
The helper writes the per-JTBD ``complete_hire_idempotency_keys``
...
IDEMPOTENCY_TABLE: str = "complete_hire_idempotency_keys"
...
async def check_idempotency_key(
	*,
	...
	raise NotImplementedError(
		...
		"See backend/src/hiring_pipeline/complete_hire/idempotency.py "
