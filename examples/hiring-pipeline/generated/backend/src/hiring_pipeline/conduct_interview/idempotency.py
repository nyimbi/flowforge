"""Idempotency dedupe helper for Conduct interview loop (v0.3.0 W2 / item 6).

Generated by flowforge JTBD generator — do not edit by hand.

Used by the FastAPI router and domain service to enforce
``Idempotency-Key`` on ``POST /conduct-interview/events``:
...
The helper writes the per-JTBD ``conduct_interview_idempotency_keys``
...
IDEMPOTENCY_TABLE: str = "conduct_interview_idempotency_keys"
...
async def check_idempotency_key(
	*,
	...
	raise NotImplementedError(
		...
		"See backend/src/hiring_pipeline/conduct_interview/idempotency.py "
