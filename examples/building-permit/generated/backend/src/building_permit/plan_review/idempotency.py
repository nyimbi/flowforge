"""Idempotency dedupe helper for Review Building Plans for Code Compliance (v0.3.0 W2 / item 6).

Generated by flowforge JTBD generator — do not edit by hand.

Used by the FastAPI router and domain service to enforce
``Idempotency-Key`` on ``POST /plan-review/events``:
...
The helper writes the per-JTBD ``plan_review_idempotency_keys``
