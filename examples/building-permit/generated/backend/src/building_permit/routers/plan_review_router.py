"""FastAPI router for Review Building Plans for Code Compliance.

Exposes ``POST /plan-review/events`` so a frontend step
...
from ..plan_review.idempotency import (
	IDEMPOTENCY_TTL_HOURS,
	check_idempotency_key,
	fingerprint_request,
	record_idempotency_response,
)
from ..services.plan_review_service import PlanReviewService
...
router = APIRouter(prefix="/plan-review", tags=["plan_review"])
_service = PlanReviewService()
