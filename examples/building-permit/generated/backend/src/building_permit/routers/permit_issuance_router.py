"""FastAPI router for Issue the Building Permit Certificate.

Exposes ``POST /permit-issuance/events`` so a frontend step
...
from ..permit_issuance.idempotency import (
	IDEMPOTENCY_TTL_HOURS,
	check_idempotency_key,
	fingerprint_request,
	record_idempotency_response,
)
from ..services.permit_issuance_service import PermitIssuanceService
...
router = APIRouter(prefix="/permit-issuance", tags=["permit_issuance"])
_service = PermitIssuanceService()
...
async def post_event(
	...
	span_attrs: dict[str, Any] = {
		...
		"flowforge.jtbd_id": "permit_issuance",
