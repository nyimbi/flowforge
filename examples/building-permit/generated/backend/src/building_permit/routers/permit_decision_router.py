"""FastAPI router for Approve or Deny Building Permit.

Exposes ``POST /permit-decision/events`` so a frontend step
...
from ..permit_decision.idempotency import (
	IDEMPOTENCY_TTL_HOURS,
	check_idempotency_key,
	fingerprint_request,
	record_idempotency_response,
)
from ..services.permit_decision_service import PermitDecisionService
...
router = APIRouter(prefix="/permit-decision", tags=["permit_decision"])
_service = PermitDecisionService()
