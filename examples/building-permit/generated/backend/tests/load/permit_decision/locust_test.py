"""SLA stress harness for permit_decision (building_permit).
...
class PermitDecisionSlaUser(HttpUser):
	"""Fires ``POST /permit-decision/events`` at the SLA-implied rate."""
