"""SLA stress harness for permit_intake (building_permit).
...
class PermitIntakeSlaUser(HttpUser):
	"""Fires ``POST /permit-intake/events`` at the SLA-implied rate."""
