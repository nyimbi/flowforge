"""SLA stress harness for plan_review (building_permit).

Generated by flowforge — do not edit. Regen with ``flowforge jtbd-generate``.

Workflow breach budget: 864000s (240h).
...
_BUDGET_MS = 864000000
_P95_MS = 2000


class PlanReviewSlaUser(HttpUser):
	"""Fires ``POST /plan-review/events`` at the SLA-implied rate."""
