"""FastAPI router for File an insurance claim (FNOL).

Exposes ``POST /claim-intake/events`` so a frontend step
...
from ..claim_intake.idempotency import (
	IDEMPOTENCY_TTL_HOURS,
	check_idempotency_key,
	fingerprint_request,
	record_idempotency_response,
)
from ..services.claim_intake_service import ClaimIntakeService
...
router = APIRouter(prefix="/claim-intake", tags=["claim_intake"])
_service = ClaimIntakeService()
