"""Workflow adapter for File an insurance claim (FNOL).

Wraps :func:`flowforge.engine.fire.fire` for the ``claim_intake`` workflow.
...
try:  # pragma: no cover - import-time fast path
	...
	_OTEL_TRACER: Any = _otel_trace.get_tracer("flowforge.claim_intake")
