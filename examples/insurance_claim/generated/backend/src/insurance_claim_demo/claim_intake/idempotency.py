"""Idempotency dedupe helper for File an insurance claim (FNOL) (v0.3.0 W2 / item 6).

Generated by flowforge JTBD generator — do not edit by hand.

Used by the FastAPI router and domain service to enforce
``Idempotency-Key`` on ``POST /claim-intake/events``:
...
The helper writes the per-JTBD ``claim_intake_idempotency_keys``
...
IDEMPOTENCY_TABLE: str = "claim_intake_idempotency_keys"
...
async def check_idempotency_key(
	*,
	...
	raise NotImplementedError(
		...
		"See backend/src/insurance_claim_demo/claim_intake/idempotency.py "
