"""Smoke test for flowforge-jtbd-platformeng (audit-2026 E-49 / D-04).
...
from flowforge_jtbd_platformeng import DOMAIN, DISPLAY_NAME, load_bundle
...
def test_smoke_each_jtbd_has_data_capture() -> None:
	resource = files("flowforge_jtbd_platformeng") / "jtbds"
