"""flowforge JTBD domain library — Nonprofit.

Subdomains: Donor, grant, volunteer.
...
DOMAIN: str = "nonprofit"
DISPLAY_NAME: str = "Nonprofit"
SUBDOMAINS: str = "Donor, grant, volunteer"
