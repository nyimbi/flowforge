...
**Tier-A** domain library — HR industry Jobs-To-Be-Done bundle for the flowforge workflow framework.
...
bundle = json.loads(
    files("flowforge_jtbd_hr.examples").joinpath("bundle.json").read_text()
)
