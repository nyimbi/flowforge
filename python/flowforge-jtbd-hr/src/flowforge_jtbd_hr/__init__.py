"""flowforge JTBD domain library — Human Resources.

Subdomains: Hiring, onboarding, leave, performance.
...
DOMAIN: str = "hr"
DISPLAY_NAME: str = "Human Resources"
SUBDOMAINS: str = "Hiring, onboarding, leave, performance"
