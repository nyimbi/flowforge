"""flowforge JTBD domain library — Project Management.

Subdomains: Kanban, scrum, waterfall.
...
DOMAIN: str = "project-mgmt"
DISPLAY_NAME: str = "Project Management"
SUBDOMAINS: str = "Kanban, scrum, waterfall"
