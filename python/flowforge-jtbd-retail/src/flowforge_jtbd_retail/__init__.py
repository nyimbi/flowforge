"""flowforge JTBD domain library — Retail Store.

Subdomains: Clientelling, buyback, loyalty.
...
DOMAIN: str = "retail-store"
DISPLAY_NAME: str = "Retail Store"
SUBDOMAINS: str = "Clientelling, buyback, loyalty"
