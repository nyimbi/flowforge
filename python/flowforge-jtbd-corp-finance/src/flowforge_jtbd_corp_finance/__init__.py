"""flowforge JTBD domain library — Corporate Finance.

Subdomains: Treasury, budget, forecast.
...
DOMAIN: str = "corporate-finance"
DISPLAY_NAME: str = "Corporate Finance"
SUBDOMAINS: str = "Treasury, budget, forecast"
