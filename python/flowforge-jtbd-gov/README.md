...
**Tier-A** domain library — Gov industry Jobs-To-Be-Done bundle for the flowforge workflow framework.
...
bundle = json.loads(
    files("flowforge_jtbd_gov.examples").joinpath("bundle.json").read_text()
)
