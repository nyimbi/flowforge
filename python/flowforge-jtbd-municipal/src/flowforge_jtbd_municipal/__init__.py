"""flowforge JTBD domain library — Municipal.

Subdomains: Utility, zoning, parks.
...
DOMAIN: str = "municipal"
DISPLAY_NAME: str = "Municipal"
SUBDOMAINS: str = "Utility, zoning, parks"
