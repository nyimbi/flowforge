"""flowforge JTBD domain library — SaaS Ops.

Subdomains: Lifecycle, incident, onboard-tenant.
...
DOMAIN: str = "saas-ops"
DISPLAY_NAME: str = "SaaS Ops"
SUBDOMAINS: str = "Lifecycle, incident, onboard-tenant"
