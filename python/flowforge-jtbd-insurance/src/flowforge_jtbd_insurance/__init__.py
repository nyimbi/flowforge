"""flowforge JTBD domain library — Insurance.

Subdomains: Claims, underwriting, reinsurance.
...
DISPLAY_NAME: str = "Insurance"
SUBDOMAINS: str = "Claims, underwriting, reinsurance"
