"""flowforge JTBD domain library — Real Estate.

Subdomains: Listing, lease, maintenance.
...
DOMAIN: str = "real-estate"
DISPLAY_NAME: str = "Real Estate"
SUBDOMAINS: str = "Listing, lease, maintenance"
